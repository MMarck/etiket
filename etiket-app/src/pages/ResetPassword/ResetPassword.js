...
const ResetPassword = () => {
  return (
    <div className="d-flex flex-column w-50 small">
        ...
        <span id="avisoDeIngreso"><b>Cambio de contraseña</b></span>

        <p>Puedes recuperar tu contraseña ingresando tu usuario.
          Te llegará una notificación a tu correo electrónico
          registrado donde te compartiremos tu contraseña.</p>
