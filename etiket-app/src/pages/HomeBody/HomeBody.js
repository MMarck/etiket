          ...
          {isPlanesVisible ?
            <div id="planes" className={isPlanesVisible ? "isShowing":"isNotShowing"}>
              ...
              <div id="rectSelectorContainer" style={{marginTop: "5%"}}>
                <div id="emprendedorSqr" onClick={()=>this.toogleEmprendedor()} className={this.state.isEmprendedorVisible ? "planSelected":"planNotSelected"}>
                  <span>Emprendedor</span>
                </div>
                <div id="empresasSqr" onClick={()=>this.toogleEmpresa()} className={this.state.isEmpresaVisible ? "planSelected":"planNotSelected"}>
                  <span>Empresas</span>
                </div>
              </div>
              {this.changePlanes()}
