          ...
          <div id="gratis" className="planesRect">
            ...
            <div className="planesText">
              <span className="textSubHeader">
                Crea etiquetas para empaques o envases:
              </span>
              <ul
                style={{ listStyleImage: "url(/images/icons/chequeSmall.png)" }}
              >
                <li className="isFeature">
                  De forma rectangular o cuadrada{" "}
                  <span className="featureEsp">
                    (galletas, cereales, etc...)
                  </span>
                </li>
                <li className="isNotFeature">
                  De forma circular{" "}
                  <span className="featureEsp">(quesos, jamones, etc...)</span>
                </li>
                <li className="isNotFeature">
                  En botellas o latas{" "}
                  <span className="featureEsp">(cerveza, yogurt, etc...)</span>
                </li>
                <li className="isNotFeature">
                  De forma irregular{" "}
                  <span className="featureEsp">
                    (helados en forma de cono, sanduches, etc...)
                  </span>
                </li>
              </ul>
              ...
              <ul>
                <li className="isNotFeature">
                  Tabla nutricional basado en CÓDEX
                </li>
                <li className="isNotFeature">
                  Tabla nutricional basado en FDA
                </li>
                <li className="isNotFeature">
                  Tabla nutricional basado en Unión Europea
                </li>
                <li className="isNotFeature">
                  Tabla nutricional basado en México
                </li>
                <li className="isNotFeature">
                  Tabla nutricional basado en Ecuador
                </li>
                <li className="isNotFeature">
                  Tabla nutricional basado en Chile
                </li>
                <li className="isNotFeature">
                  Tabla nutricional basado en Perú
                </li>
              </ul>
            </div>
  ...
  render() {
    ...
    return (
      <div className="homebody">
        ...
        <div
          className="info"
          style={{ backgroundImage: "url(/images/fondo-web.png)" }}
        >
          {isPlanesVisible ? (
            <div
              id="planes"
              className={isPlanesVisible ? "isShowing" : "isNotShowing"}
            >
              ...
              <div id="rectSelectorContainer" style={{ marginTop: "5%" }}>
                <div
                  ...
                  className={
                    this.state.isEmprendedorVisible
                      ? "planSelected"
                      : "planNotSelected"
                  }
                >
            ...
            <div
              id="exp"
              className={isPlanesVisible ? "isNotShowing" : "isShowing"}
            >
              ...
              <div style={{ marginTop: "5%" }}>
                <p className="text">
                  Los fabricantes de alimentos y bebidas necesitan diseñar,
                  imprimir y gestionar muchos tipos de etiquetas. Comprendemos
                  que se puede volver tedioso revisar la normativa de cada
                  producto y crear una etiqueta, calcular los nutrientes y
                  diseñar una etiqueta nutricional acorde al país de
                  comercialización para cumplir las últimas tendencias del
                  mercado y las exigencias legales.
                </p>
                <p className="text">
                  Es por tal motivo, que ofrecemos una solución amigable para
                  ayudar a simplificar todo el proceso de etiquetado, empezando
                  con la creación del prototipo de una etiqueta de alimentos que
                  cumpla la normativa local o del paísal que desea exportar.
                </p>
              </div>
              <div className="infoSquare">
                <img
                  ...
                  alt="etiqueta"
                  className="imgInfoIcon"
                ></img>
                <p className="squareText">
                  Cree e imprima fácilmente etiquetas para alimentos,
                  suplementos, bebidas alchólicas y no alcohólicas.
                </p>
              </div>
              <div className="infoSquare">
                <img
                ...
                ></img>
                <p className="squareText">
                  Diseñe etiquetas nutricionales espectaculares que cumplan con
                  las normativas de la UE y la FDA.
                </p>
              </div>
              <div className="infoSquare">
                <img
                  src="/images/icons/wheat.png"
                  alt="planta"
                  className="imgInfoIcon"
                ></img>
                <p className="squareText">
                  La función gestión de textos etiquetados destaca los alérgenos
                  de manera automática cuando aparecen en las listas de
                  ingredientes
                </p>
              </div>
              <div id="verPlanes" onClick={() => this.togglePlanes()}>
