...
export const etiquetaSlice = createSlice({
  ...
  reducers: {
    ...
    loadLabel: (state, action) => {
      ...
      state["sizeIndicatorVisibility"] =
        action.payload.dimensiones.sizeIndicatorVisibility;
      ...
      state["tamanioPorcionUn"] =
        action.payload.TablaNutri.tamanioPorcion.unidad;
      state["porcionPorEnvaseDisabled"] =
        action.payload.TablaNutri.porcionPorEnvase.isDisabled;
      state["porcionPorEnvase"] =
        action.payload.TablaNutri.porcionPorEnvase.valor;
      state["porcionPorEnvaseUn"] =
        action.payload.TablaNutri.porcionPorEnvase.unidad;
      ...
      state["energiaTotalJulios"] =
        action.payload.TablaNutri.energiaTotal.julios;
      state["energiaTotalCalorias"] =
        action.payload.TablaNutri.energiaTotal.calorias;
    },
  },
});
